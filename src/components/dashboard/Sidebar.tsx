    ...
    <>
      ...
      >
        ...
        <div className="h-[72px] flex items-center px-6 border-b border-white/[0.06]">
          <Link href="/dashboard" className="flex items-center gap-3 group">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-gold to-gold-dark flex items-center justify-center shadow-lg shadow-gold/20">
              <span className="text-navy-dark font-extrabold text-xs tracking-wider">
                PSK
              </span>
            </div>
            <div className="flex flex-col">
              ...
              <span className="text-gold/60 text-[10px] font-medium tracking-wide">
                MANAGEMENT SYSTEM
              </span>
            </div>
          </Link>
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`flex-shrink-0 transition-colors duration-200 ${active ? "text-gold" : "text-gray-500 group-hover:text-gray-300"}`}
                >
                  {item.icon}
                </span>
        ...
        <div className="p-3 pb-6">
          ...
          >
            <svg
              className="w-5 h-5 flex-shrink-0 text-gray-600 group-hover:text-gold-light transition-colors"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
            ...
            <span>사이트 바로가기</span>
            <svg
              className="w-3.5 h-3.5 ml-auto opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200 text-gold-light"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
