          ...
          const others = listData.posts
            ...
            .sort(
              (a: RelatedPost, b: RelatedPost) =>
                new Date(b.작성일).getTime() - new Date(a.작성일).getTime(),
            )
            .slice(0, 3);
          setRelated(others);
        }
    ...
    return (
      <div className="jni-post-section">
        ...
        >
          ...
          <Link
            href="/#board"
            className="inline-flex items-center gap-2 px-6 py-3 gold-gradient-bg rounded-full text-navy font-bold text-sm hover:opacity-90 transition-opacity"
          >
            <svg
              width="16"
              height="16"
                ...
                <div className="jni-post-related-grid">
                  {related.map((r) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <span
                          className={`inline-block px-2.5 py-0.5 rounded-full text-[11px] font-bold text-white mb-2 ${
                            r.카테고리 === "성공사례"
                              ? "bg-emerald-600"
                              : r.카테고리 === "인증지원"
                                ? "bg-amber-600"
                        ...
                        <h4 className="text-[14px] font-bold text-light leading-snug line-clamp-2 group-hover:text-gold transition-colors">
                          {r.제목}
                        </h4>
                        <p className="text-[12px] text-body/50 mt-2">
                          {formatDate(r.작성일)}
                        </p>
                      </div>
                    </Link>
