...
const AUTOSAVE_KEY = "pskim_board_draft";
...
function BoardEditor() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/board?id=${editId}`)
      ...
      .catch(() =>
        setMessage({ type: "error", text: "게시글을 불러올 수 없습니다." }),
      )
